...
Cette appli permet de gérer une liste de livre, leurs auteurs, leurs genres, leurs emprunteurs ainsi que leurs emprunts.

## Install

    git clone https://github.com/Maryline-frem/ecf-bibliotheque.git
    cd ecf-bibliotheque
    composer install
