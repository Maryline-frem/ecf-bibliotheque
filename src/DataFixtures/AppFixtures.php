...
class AppFixtures extends Fixture
{
    ...
    public function loadUsers(ObjectManager $manager, array $borrowers, int $usersPerBorrower, int $count)
    {
        $users = [];
